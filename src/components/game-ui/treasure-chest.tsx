...
export const TreasureChest = ({ project, onOpen }: TreasureChestProps) => {
  return (
    <div className="relative w-48 h-48 bg-gray-800 border-4 border-stone-800 rounded-lg shadow-xl flex flex-col items-center justify-center p-4 animate-pulse-slow">
      <div className="absolute top-0 left-0 right-0 h-1/3 bg-gray-700 rounded-t-md border-b-4 border-stone-800 flex items-center justify-center">
