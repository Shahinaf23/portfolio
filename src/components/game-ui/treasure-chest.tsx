...
export const TreasureChest = ({ project, onOpen }: TreasureChestProps) => {
  return (
    <div className="relative w-48 h-48 bg-amber-500 border-4 border-amber-600 rounded-lg shadow-xl flex flex-col items-center justify-center p-4 animate-pulse-slow">
      <div className="absolute top-0 left-0 right-0 h-1/3 bg-amber-400 rounded-t-md border-b-4 border-amber-600 flex items-center justify-center">
