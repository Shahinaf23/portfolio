...
export const AboutMeSection = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full w-full p-4">
      ...
      {gateOpen && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-800 p-8 rounded-lg shadow-xl max-w-md text-white text-center animate-fade-in">
