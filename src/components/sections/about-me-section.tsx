      ...
      {gateOpen && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-800 bg-opacity-80 p-8 rounded-lg shadow-xl max-w-md text-white text-center animate-fade-in">
          <p className="text-lg mb-4">
            Greetings, fellow adventurer! I’m Shahina Fathima, a passionate Software Engineer and Data Engineer with a knack for turning raw data into powerful insights and building systems that run as smoothly as a well-oiled machine.
My journey in the digital realm began with a curiosity for how technology could solve real-world challenges. Over time, I’ve navigated through the jungles of code, mastered the tools of data pipelines, and unlocked treasures of knowledge in Python, SQL, and cloud-based engineering
          </p>
          <p className="text-md">
